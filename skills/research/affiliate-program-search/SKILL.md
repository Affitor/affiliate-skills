...
- **API (preferred):** `GET https://openaffiliate.dev/api/programs?q=<term&utm_source=affiliate-skills>&utm_source=affiliate-skills` — public, no auth needed, structured data
