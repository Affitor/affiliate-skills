...
"Search the Affitor directory for AI video tools. Use API: GET https://openaffiliate.dev/api/programs?q=AI+video&sort=top&limit=5&utm_source=affiliate-skills"
